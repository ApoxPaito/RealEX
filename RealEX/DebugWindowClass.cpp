...
bool DebugWindowClass::UpdateBuffers(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
	...
	// First triangle.
	vertices[0].position = DXFLOAT3(left, top, 0.0f);  // Top left.
	vertices[0].texture = DXFLOAT2(0.0f, 0.0f);

	vertices[1].position = DXFLOAT3(right, bottom, 0.0f);  // Bottom right.
	vertices[1].texture = DXFLOAT2(1.0f, 1.0f);

	vertices[2].position = DXFLOAT3(left, bottom, 0.0f);  // Bottom left.
	vertices[2].texture = DXFLOAT2(0.0f, 1.0f);

	// Second triangle.
	vertices[3].position = DXFLOAT3(left, top, 0.0f);  // Top left.
	vertices[3].texture = DXFLOAT2(0.0f, 0.0f);

	vertices[4].position = DXFLOAT3(right, top, 0.0f);  // Top right.
	vertices[4].texture = DXFLOAT2(1.0f, 0.0f);

	vertices[5].position = DXFLOAT3(right, bottom, 0.0f);  // Bottom right.
