...
bool ShadowShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*) L"../RealEX/shadow.vs", (WCHAR*) L"../RealEX/shadow.ps");
	if (!result)
	{
		return false;
	}
...
bool ShadowShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, DXMATRIX worldMatrix, DXMATRIX viewMatrix,
	DXMATRIX projectionMatrix, DXMATRIX lightViewMatrix, DXMATRIX lightProjectionMatrix,
	ID3D11ShaderResourceView* depthMapTexture, DXFLOAT3 lightPosition)
{
	bool result;
...
bool ShadowShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, DXMATRIX worldMatrix, DXMATRIX viewMatrix,
	DXMATRIX projectionMatrix, DXMATRIX lightViewMatrix, DXMATRIX lightProjectionMatrix,
	ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* depthMapTexture, DXFLOAT3 lightPosition,
	DXFLOAT4 ambientColor, DXFLOAT4 diffuseColor, DXMATRIX lightViewMatrix2, DXMATRIX lightProjectionMatrix2,
	ID3D11ShaderResourceView* depthMapTexture2, DXFLOAT3 lightPosition2, DXFLOAT4 diffuseColor2)
{
	bool result;
...
bool ShadowShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	// Note to yourself Paitone, don't forget to change the byte widths of the buffers when you play around with structs
...
bool ShadowShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, DXMATRIX worldMatrix, DXMATRIX viewMatrix,
	DXMATRIX projectionMatrix, DXMATRIX lightViewMatrix, DXMATRIX lightProjectionMatrix,
	ID3D11ShaderResourceView* depthMapTexture, DXFLOAT3 lightPosition)
{
	HRESULT result;
...
bool ShadowShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, DXMATRIX worldMatrix, DXMATRIX viewMatrix,
	DXMATRIX projectionMatrix, DXMATRIX lightViewMatrix, DXMATRIX lightProjectionMatrix,
	ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* depthMapTexture, DXFLOAT3 lightPosition,
	DXFLOAT4 ambientColor, DXFLOAT4 diffuseColor, DXMATRIX lightViewMatrix2,
	DXMATRIX lightProjectionMatrix2, ID3D11ShaderResourceView* depthMapTexture2, DXFLOAT3 lightPosition2,
