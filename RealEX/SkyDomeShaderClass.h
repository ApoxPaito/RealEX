...
public:
	...
	void Shutdown();
	bool Render(ID3D11DeviceContext*, int, DXMATRIX, DXMATRIX, DXMATRIX, DXFLOAT4, DXFLOAT4);
...
private:
	...
	bool SetShaderParameters(ID3D11DeviceContext*, DXMATRIX, DXMATRIX, DXMATRIX, DXFLOAT4, DXFLOAT4);
